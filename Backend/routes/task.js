  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("get-started", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("research", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("apply", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("transcripts", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("eng-proficiency", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("testing", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("accepted", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("visa", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("relocate", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("tips", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
  ...
  if (res.locals.authenticated) {
    await Task.findOne({
      ...
      .then((tasks) => {
        ...
        res.render("task", { tasks, username: req.jwtPayload.name });
      })
      .catch(error => {
        console.error(error);
        res.status(500).send("Error retrieving Tasks");
